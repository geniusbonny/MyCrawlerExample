...
public class FacebookExample {
	...
	public static void main(String[] args) {
		...
		String uri = 
				...
				+ "/search?q=stock&type=page&limit=1000&fields=name,id,likes,talking_about_count"
				+ "&access_token=EAACEdEose0cBAHnbuGkEM2AhfHKFkYNZAPvApDbNmlzAn9sNwsPWNz6DtA0qoVxvVhSZCjf72qM2o4WfFcKHZAIQgQxwiu0VsPeJ0KG7QTDZBEDoEIT1XolLGtAC2TR9ZCQtZCgYljMAFucYzYbqFRnobcRs4meMeYtw2UmZCfqanu4tAWEDyvI4RUwZCD5SsZCAZD";
